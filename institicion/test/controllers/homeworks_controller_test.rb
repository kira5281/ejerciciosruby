...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { cod_asignatura: @homework.cod_asignatura, enunciado: @homework.enunciado, fecha_final: @homework.fecha_final }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { cod_asignatura: @homework.cod_asignatura, enunciado: @homework.enunciado, fecha_final: @homework.fecha_final }
    assert_redirected_to homework_path(assigns(:homework))
  end
